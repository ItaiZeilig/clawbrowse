// End-to-end round-trip test for the pawbrowse MCP server.
...
const srv = spawn('node', [SERVER], {
  env: { ...process.env, PAWBROWSE_PORT: String(PORT) },
...
if (init?.result?.serverInfo?.name !== 'pawbrowse') fail('initialize did not return serverInfo.name=pawbrowse');
