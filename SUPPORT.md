...
Need help with ClawBrowse? Here's where to go.
...
- **Something's broken** — open a [bug report](https://github.com/ItaiZeilig/clawbrowse/issues/new/choose).
- **Feature ideas** — open a [feature request](https://github.com/ItaiZeilig/clawbrowse/issues/new/choose).
...
- **Extension badge isn't green** — the MCP server isn't running or the port doesn't match.
  ...
  matches `CLAWBROWSE_PORT` (default `10577`).
...
[GitHub Discussions]: https://github.com/ItaiZeilig/clawbrowse/discussions
