# PawBrowse Privacy Policy

_Last updated: 2026-09-22_

PawBrowse is an open-source developer tool that lets a local AI coding agent (such as
...
**PawBrowse does not collect, store, transmit, or sell any personal data to us or to any
...
i.e. `localhost`), which is the PawBrowse MCP server that you run yourself. When your local
...
agent you are running. It is never sent to the PawBrowse developer or to any remote service
by this extension.
...
PawBrowse does **not** handle or collect: personally identifiable information for the
...
connect PawBrowse to (for example, Claude Code) has its own privacy terms governing what it
does with the page content you send it. PawBrowse itself adds no additional destination.
